...
run_example:
	docker rm -f service0; docker rm -f service1; docker rm -f service2; docker rm -f service3; docker rm -f task0; docker rm -f task1; docker rm -f task2; export DOCKER_API_VERSION=1.39; ./dist/testdrive -v
